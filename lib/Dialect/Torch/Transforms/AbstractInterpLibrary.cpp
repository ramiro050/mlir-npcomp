...
"    %int0 = torch.constant.int 0\n"
"    %int1 = torch.constant.int 1\n"
"    %0 = torch.prim.TupleIndex %arg0, %int0 : !torch.tuple<int, int>, !torch.int -> !torch.int\n"
"    %1 = torch.prim.TupleIndex %arg0, %int1 : !torch.tuple<int, int>, !torch.int -> !torch.int\n"
"    %2 = call @__torch__.complex_to_float(%0, %1) : (!torch.int, !torch.int) -> !torch.int\n"
"    return %2 : !torch.int\n"
"  }\n"
"  func.func @__torch__.complex_to_float(%arg0: !torch.int, %arg1: !torch.int) -> !torch.int {\n"
"    %none = torch.constant.none\n"
...
"    %0 = torch.prim.Uninitialized : !torch.int\n"
"    %1 = torch.aten.eq.int %arg1, %int8 : !torch.int, !torch.int -> !torch.bool\n"
"    %2 = torch.prim.If %1 -> (!torch.int) {\n"
"      torch.prim.If.yield %int5 : !torch.int\n"
"    } else {\n"
"      %3 = torch.aten.eq.int %arg1, %int9 : !torch.int, !torch.int -> !torch.bool\n"
"      %4 = torch.prim.If %3 -> (!torch.int) {\n"
"        torch.prim.If.yield %int6 : !torch.int\n"
"      } else {\n"
"        %5 = torch.aten.eq.int %arg1, %int10 : !torch.int, !torch.int -> !torch.bool\n"
"        %6 = torch.prim.If %5 -> (!torch.int) {\n"
