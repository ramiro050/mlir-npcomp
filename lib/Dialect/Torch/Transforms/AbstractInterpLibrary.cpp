...
"      %3 = torch.prim.If %2 -> (!torch.tuple<list<int>, list<int>, list<int>>) {\n"
"        %4 = torch.aten.__getitem__.t %arg0, %int1 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %5 = torch.prim.ListConstruct %4 : (!torch.int) -> !torch.list<int>\n"
"        %6 = torch.aten.__getitem__.t %arg0, %int1 : !torch.list<int>, !torch.int -> !torch.int\n"
"        %7 = torch.prim.ListConstruct %6 : (!torch.int) -> !torch.list<int>\n"
"        %8 = torch.prim.TupleConstruct %arg0, %5, %7 : !torch.list<int>, !torch.list<int>, !torch.list<int> -> !torch.tuple<list<int>, list<int>, list<int>>\n"
"        torch.prim.If.yield %8 : !torch.tuple<list<int>, list<int>, list<int>>\n"
"      } else {\n"
"        %4 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"        %5 = torch.prim.ListConstruct  : () -> !torch.list<int>\n"
"        %6 = torch.prim.TupleConstruct %arg0, %4, %5 : !torch.list<int>, !torch.list<int>, !torch.list<int> -> !torch.tuple<list<int>, list<int>, list<int>>\n"
"        torch.prim.If.yield %6 : !torch.tuple<list<int>, list<int>, list<int>>\n"
"      }\n"
"      torch.prim.If.yield %3 : !torch.tuple<list<int>, list<int>, list<int>>\n"
"    } else {\n"
"      %1 = torch.aten.__is__ %arg3, %none : !torch.optional<list<int>>, !torch.none -> !torch.bool\n"
"      %2 = torch.prim.If %1 -> (!torch.list<int>) {\n"
"        %6 = torch.prim.ListConstruct %int0 : (!torch.int) -> !torch.list<int>\n"
"        torch.prim.If.yield %6 : !torch.list<int>\n"
"      } else {\n"
"        %6 = torch.prim.unchecked_cast %arg3 : !torch.optional<list<int>> -> !torch.list<int>\n"
"        torch.prim.If.yield %6 : !torch.list<int>\n"
"      }\n"
"      %3 = torch.aten.__is__ %arg4, %none : !torch.optional<list<int>>, !torch.none -> !torch.bool\n"
"      %4 = torch.prim.If %3 -> (!torch.list<int>) {\n"
"        %6 = torch.prim.ListConstruct %int0 : (!torch.int) -> !torch.list<int>\n"
"        torch.prim.If.yield %6 : !torch.list<int>\n"
"      } else {\n"
"        %6 = torch.prim.unchecked_cast %arg4 : !torch.optional<list<int>> -> !torch.list<int>\n"
"        torch.prim.If.yield %6 : !torch.list<int>\n"
"      }\n"
...
"    %0 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_float_dtypes() : () -> !torch.list<int>\n"
"    %1 = torch.aten.__contains__.int_list %0, %arg0 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    return %1 : !torch.bool\n"
"  }\n"
"  func.func @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_float_dtypes() -> !torch.list<int> {\n"
...
"    %0 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_complex_dtypes() : () -> !torch.list<int>\n"
"    %1 = torch.aten.__contains__.int_list %0, %arg0 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    return %1 : !torch.bool\n"
"  }\n"
"  func.func @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_complex_dtypes() -> !torch.list<int> {\n"
...
"    %0 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_integer_dtypes() : () -> !torch.list<int>\n"
"    %1 = torch.aten.__contains__.int_list %0, %arg0 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    return %1 : !torch.bool\n"
"  }\n"
"  func.func @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_integer_dtypes() -> !torch.list<int> {\n"
"    %int4 = torch.constant.int 4\n"
"    %int3 = torch.constant.int 3\n"
"    %int2 = torch.constant.int 2\n"
"    %int1 = torch.constant.int 1\n"
...
"      %9 = func.call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%7, %8) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"      torch.prim.If.yield %9 : !torch.int\n"
"    }\n"
"    return %6 : !torch.int\n"
"  }\n"
