...
"      torch.prim.If.yield\n"
"    }\n"
"    %1 = torch.prim.ListConstruct %arg0, %none : (!torch.int, !torch.none) -> !torch.list<optional<int>>\n"
...
"    %3 = torch.prim.ListConstruct %arg1, %2 : (!torch.int, !torch.int) -> !torch.list<int>\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %2 = torch.prim.ListConstruct %arg0, %arg2 : (!torch.int, !torch.int) -> !torch.list<optional<int>>\n"
"    %3 = torch.prim.ListConstruct %arg1, %arg3 : (!torch.int, !torch.int) -> !torch.list<int>\n"
...
"    %int11 = torch.constant.int 11\n"
"    %int5 = torch.constant.int 5\n"
"    %0 = torch.prim.ListConstruct %int5, %int11 : (!torch.int, !torch.int) -> !torch.list<int>\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %3 = torch.prim.ListConstruct %int5, %int11 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %4 = torch.aten.__contains__.int_list %3, %arg3 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %5 = torch.aten.__not__ %4 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %5 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
...
"    return %5 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.div.Tensor_mode\"(%arg0: !torch.int, %arg1: !torch.int, %arg2: !torch.int, %arg3: !torch.int, %arg4: !torch.optional<str>) -> !torch.int {\n"
"    %false = torch.constant.bool false\n"
"    %int6 = torch.constant.int 6\n"
"    %true = torch.constant.bool true\n"
"    %0 = torch.prim.ListConstruct %arg0, %arg2 : (!torch.int, !torch.int) -> !torch.list<optional<int>>\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %4 = torch.prim.ListConstruct %arg0, %arg2 : (!torch.int, !torch.int) -> !torch.list<optional<int>>\n"
"    %5 = torch.prim.ListConstruct %arg1, %arg3 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %6 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%4, %5) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %7 = torch.prim.ListConstruct %arg0, %arg2 : (!torch.int, !torch.int) -> !torch.list<optional<int>>\n"
"    %8 = torch.prim.ListConstruct %arg1, %arg3 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %9 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%7, %8) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"    return %9 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.sub.Tensor\"(%arg0: !torch.int, %arg1: !torch.int, %arg2: !torch.int, %arg3: !torch.int, %arg4: !torch.union<float, int>) -> !torch.int {\n"
...
"    return %4 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.aten.threshold_backward\"(%arg0: !torch.int, %arg1: !torch.int, %arg2: !torch.int, %arg3: !torch.int, %arg4: !torch.union<float, int>) -> !torch.int {\n"
...
"    %5 = torch.prim.ListConstruct %arg1, %arg3 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %6 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%4, %5) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"    %7 = torch.prim.ListConstruct %int11, %int5 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %8 = torch.aten.__contains__.int_list %7, %6 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %9 = torch.aten.__not__ %8 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %9 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
