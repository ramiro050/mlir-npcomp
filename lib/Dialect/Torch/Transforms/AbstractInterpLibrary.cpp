...
"    %0:2 = torch.prim.TupleUnpack %arg1 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %1:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %2 = torch.aten.eq.int %1#1, %int30 : !torch.int, !torch.int -> !torch.bool\n"
"    %3 = torch.prim.If %2 -> (!torch.int) {\n"
"      torch.prim.If.yield %int1 : !torch.int\n"
"    } else {\n"
"      %4 = torch.aten.eq.int %0#1, %int30 : !torch.int, !torch.int -> !torch.bool\n"
"      %5 = torch.prim.If %4 -> (!torch.int) {\n"
"        torch.prim.If.yield %int1 : !torch.int\n"
"      } else {\n"
"        %6 = torch.prim.ListConstruct %1#0, %0#0 : (!torch.int, !torch.int) -> !torch.list<optional<int>>\n"
"        %7 = torch.prim.ListConstruct %1#1, %0#1 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"        %8 = func.call @__torch__.torch_mlir.jit_ir_importer.build_tools.library_generator.promote_dtypes(%6, %7) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"        torch.prim.If.yield %8 : !torch.int\n"
"      }\n"
"      torch.prim.If.yield %5 : !torch.int\n"
"    }\n"
...
"    %int30 = torch.constant.int 30\n"
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %1 = torch.aten.eq.int %0#1, %int30 : !torch.int, !torch.int -> !torch.bool\n"
"    %2 = torch.prim.If %1 -> (!torch.int) {\n"
"      torch.prim.If.yield %0#1 : !torch.int\n"
"    } else {\n"
"      %3 = torch.prim.ListConstruct %0#0, %none : (!torch.int, !torch.none) -> !torch.list<optional<int>>\n"
"      %4 = func.call @__torch__.torch_mlir.jit_ir_importer.build_tools.library_generator.get_dtype_of_scalar(%arg1) : (!torch.number) -> !torch.int\n"
"      %5 = torch.prim.ListConstruct %0#1, %4 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"      %6 = func.call @__torch__.torch_mlir.jit_ir_importer.build_tools.library_generator.promote_dtypes(%3, %5) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"      torch.prim.If.yield %6 : !torch.int\n"
"    }\n"
"    return %2 : !torch.int\n"
"  }\n"
...
"    return %0#1 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_dtype_fn.autogptq.cast_to_uint4\"(%arg0: !torch.tuple<int, int>) -> !torch.int {\n"
"    %int30 = torch.constant.int 30\n"
"    return %int30 : !torch.int\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.autogptq.cast_to_uint4\"(%arg0: !torch.list<int>) -> !torch.list<int> {\n"
"    return %arg0 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_has_value_semantics_fn.autogptq.cast_to_uint4\"() -> !torch.none {\n"
"    %none = torch.constant.none\n"
"    return %none : !torch.none\n"
"  }\n"
"}\n"
