...
class MaxPool2dEmptyStrideModule(torch.nn.Module):
...
@register_test_case(module_factory=lambda: MaxPool2dEmptyStrideModule())
def MaxPool2dEmptyStrideModule_basic(module, tu: TestUtils):
    module.forward(tu.rand(1, 1, 20, 20, low=-1))
